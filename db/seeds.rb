...
# user1 = User.create(username: "TommyB", email: "tommyb87")
# user2 = User.create(username: "Bobby6Killer" , email: "bobb6klr" )
# user3 = User.create(username: "Cool-Boy", email: "coolness89" )
# user4 = User.create(username: "Kill3r", email: "Kill3rsss" )
# user5 = User.create(username: "BabyGirl", email: "babyg92" )
# user6 = User.create(username: "PandaB", email: "pandababa" )
# user7 = User.create(username: "DavidS", email: "davisi82")
